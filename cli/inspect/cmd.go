...
// NewCmd creates a new cobra.Command for the inspect subcommand.
...
func (o *Options) formatManifestDescriptors(w io.Writer, descs []ocispec.Descriptor) error {
...
func (o *Options) formatDescriptors(w io.Writer, descs []ocispec.Descriptor) error {
	tw := tabwriter.NewWriter(w, 0, 4, 2, ' ', 0)
