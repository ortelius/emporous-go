...
// NewCmd creates a new cobra.Command for the pull subcommand.
...
func (o *Options) Run(ctx context.Context) error {
	...
	if o.AttributeQuery != "" {
		...
		pullFn = func(ctx context.Context, _ Options) ([]ocispec.Descriptor, error) {
...
func (o *Options) run(ctx context.Context, pullFn pullFunc) error {
...
type pullFunc func(context.Context, Options) ([]ocispec.Descriptor, error)

func withAttributes(ctx context.Context, o Options) ([]ocispec.Descriptor, error) {
...
// output directory.
func (o *Options) moveToResults(itr model.Iterator, matcher matchers.PartialAttributeMatcher) (total int, err error) {
	for itr.Next() {
		node := itr.Node()
...
func (o *Options) pullCollection(ctx context.Context, output string) ([]ocispec.Descriptor, []ocispec.Descriptor, error) {
...
// found.
func (o *Options) checkResolvedLinksError(ref string, err error) error {
	if err == nil {
		return nil
	}
...
// and cleanup method.
func (o *Options) mktempDir(parent string) (func(), string, error) {
