...
type Manager interface {
	...
	// Update adds or removes content from a collection and stores the collection in the
	// underlying content store. If successful, the root descriptor is returned.
	Update(ctx context.Context, space workspace.Workspace, dest string, add bool, remove bool, client registryclient.Client) (string, error)
}
